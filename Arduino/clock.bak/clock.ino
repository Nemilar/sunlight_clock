...
void loop() {
    ...
    byte jHeight=16;
    int localOffset=0;
    short thisLat, thisLong;
    float thisSunsetTime, thisSunriseTime;
    Serial.println("Allocating LED map.");
    slowPrintFreeRam();
    LED map[jWidth][jHeight];
    Serial.println("LED map allocation complete.");
    slowPrintFreeRam();
...
//          printf("%f", currentLocalTime);
    ...
    Serial.print("***** Loop ends with free RAM =");
    slowPrintFreeRam();  
}
